...
cart(); // если работам не  с модулями, то эту функию прямо  здесь вызываем. Функция  создает для переменной свою область видимости,поэтому  вдвух разных фукнциях могут существовать  перменные с одинаковыми именами
